      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-2xl">
          ...
          {entries.length > 0 ? (
            <div className="space-y-4">
              {entries.map((entry) => (
                <div key={entry.id} className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg border border-gray-200 dark:border-gray-600">
